...
avg_price = sum_one_each/len([broccoli, leek, potato, brussel_sprout])
num_broccolis = 5
num_leeks = 2
num_potatoes = 7
num_brussel_sprouts = 10
sum_total = sum([broccoli*num_broccolis, leek*num_leeks, potato*num_potatoes, brussel_sprout*num_brussel_sprouts])
